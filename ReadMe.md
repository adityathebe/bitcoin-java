...
### April 5
- [Address Generator & Validator](https://www.mobilefish.com/services/cryptocurrency/cryptocurrency.html)
- [Bitcoin Key Generation in Python](https://asecuritysite.com/encryption/bit_keys)
- [SECP256k1 Java implementation](https://www.javatips.net/api/cosigner-master/cosigner-common/src/main/java/io/emax/cosigner/common/crypto/Secp256k1.java)
- [Block Cypher - Decode raw Transaction](https://live.blockcypher.com/btc/decodetx/)
- [MobileFish Raw Transaction Parser](https://www.mobilefish.com/services/cryptocurrency/brainwallet.html#tx)
- [Genesis Raw Transaction](https://www.mobilefish.com/download/cryptocurrency/bitcoin_genesis_raw_tx.txt)
- [Parsing Raw Transaction | YouTube (MobileFish)](https://www.youtube.com/watch?v=26nDcvCExW0)
- [Bitcoin Developer Reference](https://bitcoin.org/en/developer-reference#raw-transaction-format)
...
- [ECDSA Verification and Signing Code Java](https://www.programcreek.com/java-api-examples/?class=org.bouncycastle.crypto.signers.ECDSASigner&method=verifySignature)
